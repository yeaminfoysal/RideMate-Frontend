    ...
    return (
        <div className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 mx-auto max-w-7xl">
            ...
            <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-12 md:mb-16">
                ...
                <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent mb-3 sm:mb-4 md:mb-6 px-4">
                    We Offer The Best For You
                </h2>
                <p className="text-muted-foreground text-xs md:text-sm lg:text-base leading-relaxed px-4 sm:px-6">
            ...
            {/* Cards Grid */}
            <div className="mt-8 sm:mt-10 md:mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 justify-between items-center sm:items-stretch gap-6 sm:gap-6 md:gap-8 lg:gap-10">
