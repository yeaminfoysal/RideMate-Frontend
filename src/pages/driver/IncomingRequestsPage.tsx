...
export default function IncomingRequestsPage() {
    ...
    const isOnline = driverData?.data?.isOnline ?? false;
    const approvalStatus = driverData?.data?.approvalStatus;
    const activeRide = driverData?.data?.activeRide;
        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-screen px-6 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-400 max-w-md">
                    Your account is currently <span className="font-semibold">{approvalStatus}</span>.
                    You cannot receive rides until it is approved.
                </p>
            </div>
        );
    }

    // Redirect if driver already has an active ride
    if (activeRide) {
    ...
    if (!isOnline) {
        return (
            <div className="flex flex-col items-center justify-center min-h-screen px-6 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-400 max-w-md">
                    While you’re offline, you won’t receive new ride requests.
                    Switch your status to <span className="font-semibold">Online</span> from the sidebar to start accepting rides.
                </p>
            </div>
        );
    }
